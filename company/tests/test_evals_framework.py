    ...
    return EvalSuite(
        ...
        criteria=(
            EvalCriterion(
                ...
                "company/strategy/voice.md"),
            EvalCriterion(
                "native", "Native shape", "The shape fits the channel.",
                "company/departments/_shared/skills/copywriting-en/SKILL.md", severity="warn"),
        ),
    )
...
class CoreModelTests(unittest.TestCase):
    def test_core_model_holds_grounded_criteria_and_thresholds(self):
        ...
        self.assertEqual("company/strategy/voice.md", suite.criteria[0].source)
...
class ReportComputationTests(unittest.TestCase):
    ...
    def test_warn_criteria_are_advisory_unless_all_pass(self):
        suite = EvalSuite(
            ...
            criteria=(
                EvalCriterion("must", "Must", "Blocking check.", "company/strategy/voice.md"),
                EvalCriterion("nice", "Nice", "Advisory check.", "company/strategy/voice.md",
                              severity="warn"),
            ),
        )
