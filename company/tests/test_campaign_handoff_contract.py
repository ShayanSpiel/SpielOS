...
from company.runtime.campaign_contract import (
    LINK_IN_BIO,
    SCHEMA_VERSION,
    SPIELOS_REMINDER,
...
class CampaignHandoffContractTests(unittest.TestCase):
    ...
    @unittest.skipUnless((ROOT / "scripts/promote-campaign-assets.mjs").is_file(),
                         "application asset promotion belongs to the application repository")
