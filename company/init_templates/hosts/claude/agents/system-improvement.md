...
4. Follow the operating rules in AGENTS.md (Claude Code loads it through the
   CLAUDE.md bridge) for what may be reintroduced into the product; do not
   invent retired legacy concepts or names.
