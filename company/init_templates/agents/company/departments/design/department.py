...
from ...runtime.campaign_contract import PLATFORMS, advance_campaign, creative_signature, validate_campaign
...
class DesignDepartment(EvidenceDepartment, Department):
    ...
    workflows = (
        WorkflowSpec(
            ...
            graph=(WorkflowStep("render", "agent", "designer",
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("render_sizes", "agent", "designer",
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("render", "agent", "video-producer",
