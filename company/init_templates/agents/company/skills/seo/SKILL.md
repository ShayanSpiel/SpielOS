...
6. `.agents/company/skills/copywriting/SKILL.md` — English copy quality
7. `.agents/company/skills/copywriting/SKILL.md` — Persian copy quality
8. `.agents/company/skills/translation-fa/SKILL.md` — Persian translation quality
9. `persian-glossary.md` — Persian terminology

### Before analytics changes, read:

10. `.agents/company/skills/analytics/SKILL.md`
...
The SEO skill may check that analytics is present (GA4, PostHog, Search Console verification) but must defer all implementation decisions to `.agents/company/skills/analytics/SKILL.md`.
