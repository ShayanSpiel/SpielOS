...
Use the shared runtime in `company/` as the only goal, loop, status,
...
`company/departments/outbound/`. Private campaign inputs live in
...
3. Qualify against `company/strategy/icp.md`.
