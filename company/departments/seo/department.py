...
class SeoDepartment(EvidenceDepartment, Department):
    ...
    workflows = (
        WorkflowSpec(
            ...
            graph=(WorkflowStep("validate", "agent", "seo-researcher",
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("outline", "agent", "seo-researcher",
                                produces=("seo_brief",),
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("brief", "agent", "seo-operator",
        ...
        WorkflowSpec(
            ...
            graph=(
                ...
                WorkflowStep("implement", "agent", "seo-operator",
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("report", "agent", "seo-operator",
