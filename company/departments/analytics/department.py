...
from ...runtime.campaign_contract import funnel_metrics, validate_campaign
...
class AnalyticsDepartment(EvidenceDepartment, Department):
    ...
    workflows = (
        WorkflowSpec(
            ...
            graph=(WorkflowStep("report", "agent", "analytics-operator",
        ...
        WorkflowSpec(
            ...
            graph=(
                ...
                WorkflowStep("run", "agent", "cro-optimizer",
        ...
        WorkflowSpec(
            ...
            graph=(WorkflowStep("attach", "agent", "analytics-operator",
