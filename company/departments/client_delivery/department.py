    ...
    workflows = (
        WorkflowSpec(
            ...
            graph=(
                ...
                WorkflowStep('verify_archive', 'agent', 'delivery-manager', produces=('workflow_delivery_record',), requires=('flow_receipt',), skill_ids=('client-delivery',), connection_ids=()),
            ),
        ),
        WorkflowSpec(
            'demo_workflow_build',
            ...
            graph=(
                ...
                WorkflowStep('order_scope_approved', 'approval', None, produces=(), requires=('workflow_spec',), skill_ids=(), connection_ids=()),
                WorkflowStep('build', 'connection', 'workflow-builder', produces=('flow_receipt',), requires=('workflow_spec',), skill_ids=('client-delivery',), connection_ids=('activepieces',)),
                WorkflowStep('verify_archive', 'agent', 'delivery-manager', produces=('demo_delivery_record',), requires=('flow_receipt',), skill_ids=('client-delivery',), connection_ids=()),
            ),
        ),
    )
    goal_schema = {
